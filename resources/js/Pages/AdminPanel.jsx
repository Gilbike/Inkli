            ...
            <Container>
                ...
                <DefaultCard title="Manage Users" className="mt-3">
                    <div className="overflow-auto h-96 w-full flex flex-col gap-2">
                        {users.map((x) => (
                            <div
                                className="bg-light2 dark:bg-dark2 rounded px-3 py-2 flex flex-row justify-between items-center"
                                key={x.id}
                            >
                            ...
                            <div className="flex flex-row gap-3 overflow-auto">
                                {users
                                    ...
                                    .map((x) => (
                                        <div
                                            key={x.id}
                                            className="bg-light2 dark:bg-dark2 rounded px-3 py-2 flex flex-row justify-between items-center w-fit gap-2"
                                        >
                                            <a
                                                href={route("user", {
                                                    user: x.id,
